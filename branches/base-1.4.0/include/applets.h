...
USE_RESTORECON(APPLET(restorecon, _BB_DIR_SBIN, _BB_SUID_NEVER))
...
USE_RUNCON(APPLET(runcon, _BB_DIR_SBIN, _BB_SUID_NEVER))
USE_RUNLEVEL(APPLET(runlevel, _BB_DIR_SBIN, _BB_SUID_NEVER))
USE_RX(APPLET(rx, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
USE_SECON(APPLET(secon, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
